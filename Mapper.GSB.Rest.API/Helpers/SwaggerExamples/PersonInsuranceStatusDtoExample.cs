...
{
    /// <summary>
    /// نمونه خروجی وضعیت های درخواست ثبت یا ویرایش بیمه نامه و بیمه شونده
    /// </summary>
    public class PersonInsuranceStatusDtoExample : IExamplesProvider<PersonInsuranceStatusDto>
    {
        /// <summary>
        /// ایجاد نمونه خروجی وضعیت های درخواست ثبت یا ویرایش بیمه نامه و بیمه شونده
        /// </summary>
        /// <returns></returns>
        public PersonInsuranceStatusDto GetExamples()
        {
            Guid messageUID = Guid.NewGuid();
            return new PersonInsuranceStatusDto()
            {
                RegisterUID = Guid.NewGuid(),
                Results = new List<PersonInsuranceStatusDetailsDto>
                {
