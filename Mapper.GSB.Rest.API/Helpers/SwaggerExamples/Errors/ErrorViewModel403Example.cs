...
/// </summary>
public class ErrorViewModel403Example : IExamplesProvider<ErrorViewModel>
{
    /// <summary>
    /// ایجاد نمونه خطا
    /// </summary>
    ...
    {        
        return new ErrorViewModel(new ErrorDetails(nameof(Names.User).ToLower(), ExceptionsMessages.User_is_not_authorized.Replace("{0}", Names.Data), ErrorType.LogicalError));
    }
}
