...
/// </summary>
public class ErrorViewModel401Example : IExamplesProvider<ErrorViewModel>
{
    /// <summary>
    /// ایجاد نمونه خطا
    /// </summary>
    ...
    {
        return new ErrorViewModel(new ErrorDetails(nameof(Names.User).ToLower(), ExceptionsMessages.User_is_not_authenticated, ErrorType.LogicalError));
    }
}
