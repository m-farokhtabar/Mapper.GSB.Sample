...
/// </summary>
public class AuditChangeTypeCacheKey : CacheKey<List<DvCodedText>>
{
    /// <summary>
    /// ایجاد کلید بدون نیاز به زیر کلید
    /// </summary>
    public AuditChangeTypeCacheKey()
    {
    ...
    public AuditChangeTypeCacheKey(string SubKey)
    {
        this.SubKey = SubKey;
    }
    /// <summary>
    /// نام قسمت اصلی کلید
    /// </summary>
    public override string MasterKey => "AuditChangeType";
}
